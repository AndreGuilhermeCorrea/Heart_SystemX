...
//classe controladora 
public class FormAntropometriaCT implements Icontroller {

	private FormAntropometriaSwing frame;
	...
	public void pesquisaCpf(Object view) {
		...
		if (cpf.equals("___.___.___-__")) {
			...
			if (objClient == null) {
				...
				frame.getTfNomeCliente().setText(objClient.getNomeCompleto());
	...
	public void calc(Object view) {
		...
		objAntrop.setNomeCliente(frame.getTfNomeCliente().getText());
		...
		frame.getTfPercGord().setText(doubleFormat(objAntrop.getMassaCPercentual()));
	...
	private Antropometria instanciaOBJ(FormAntropometriaSwing frame) {
		...
		objAntrop.setMassaCPercentual(Double.parseDouble(frame.getTfPercGord().getText()));
	...
	private FormAntropometriaSwing instanciaForm(Antropometria objAntrop) {
	...
	private void setarNullFrame(FormAntropometriaSwing frame) {
		frame.getTfCpfA().setText("");
		frame.getTfIdade().setText("Id");
		frame.getTfSexo().setText("Sx");
		frame.getTfNomeCliente().setText("");
