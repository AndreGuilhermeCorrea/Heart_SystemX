...
public class FormSaudeCT implements Icontroller {
	...
	private Saude instanciaOBJ(FormSaudeSwing frame) {
		...
		objSaude.setStend(frame.getTfS18().getText());
	...
	private FormSaudeSwing instanciaForm(Saude objSaude) {
		...
		frame.getTfS18().setText(objSaude.getStend());
	...
	private void setarNullFrame(FormSaudeSwing frame2) {
