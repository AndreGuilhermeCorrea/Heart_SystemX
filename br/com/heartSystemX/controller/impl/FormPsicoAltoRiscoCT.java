...
public class FormPsicoAltoRiscoCT implements Icontroller {
	...
	private FormPsicoAltoRiscoSwing frame;
	...
	public void pesquisaCpf(Object view) {
		frame = (FormPsicoAltoRiscoSwing) view;
	...
	private PsicoAltoRisco instanciaOBJ(FormPsicoAltoRiscoSwing frame) {
	...
	private FormPsicoAltoRiscoSwing InstanciaForm(PsicoAltoRisco objPAR) {
	...
	private void setarNullFrame(FormPsicoAltoRiscoSwing frame) {
