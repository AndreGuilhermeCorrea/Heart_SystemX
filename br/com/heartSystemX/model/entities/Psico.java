...
public class Psico implements Serializable {
	...
	/*
	 * 1- primeiroHP
	 * Tem interesse em acompanhamento Psicológico?
	 * 2- segundoHP
	 * Possui alguma patologia limitante para exercicio do Programa?
	 * 3- terceiroHP
	 * Possui sentimento de tristeza com frequencia?
	 * 4- quartoHP
	 * Possui sentimento de solidão com frequencia?
	 * 5- quintoHP
	 * Possui algum transtorno?
	 * 6- sextoHP
	 * Os pensamentos são organizados
	 * 7- setimoHP
	 * A linguagem e o diálogo são claros?
	 * 8- oitavoHP
	 * Possui dificuldade de concentração?
	 * 9- nonoHP
	 * Possui dificuldade de memorizar?
	 * 10- decimoHP
	 * Faz acompanhamento com psicológo ou psiquiatra?
	 * 11- decimoPrimeiroHP
	 * Já fez acompanhamento com psicológo ou psiquiatra?
	 * 12- decimoSegundoHP
	 * Sente-se Amado ou acolhido por Amigos e/ou Familiares?
	 * 13- decimoTerceiroHP
	 * Dorme bem? 
	 * 14- decimoQuartoHP
	 * Se Automedica?
	 * 15- decimoQuintoHP
	 * Faz uso elevado de Álcool?
	 * 16- decimoSextoHP
	 *  Faz uso de Drogas?
	 * 17- decimoSetimoHP
	 * Possui bom relacionamento Familiar?
	 * 18- decimoOitavoHP
	 * Possui bom relacionamento Social?
	 * 19- decimoNonoHP
	 * Prática atividade física?
	 * 20- vigesimoHP
	 * Voce possui planos para o futuro?
	 * 21- vigesimoPrimeiroHP
	 * Pra voce a vida vale a pena?
	 * 22- vigesimoSegundoHP
	 * Caso a morte surgisse ela seria bem vinda?
	 * 23- vigesimoTerceiroHP
	 * Voce ja cogitou se machucar/ferir/morrer?
	 * 24- vigesimoQuartoHP
	 * Voce ja tentou suícidio?
	 */
