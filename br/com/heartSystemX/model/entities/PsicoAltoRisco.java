...
public class PsicoAltoRisco implements Serializable {
	...
	/*
	 * Questionário investigativo para clientes cujo atendimento psiquico inicial resulta de comportamento suicida 
	 */
	
	/*
	 * 1- primeiro - 
	 * Voce tem pensado em se machucar?
	 * 2- segundo
	 * Voce pensa em dar fim a sua vida?
	 * 3- terceiro
	 * Voce tem pensado em suicídio?
	 * 4- quarto
	 * Sente que a vida perdeu o sentido?
	 * 5- quinto
	 * Voce pensou que seria melhor morrer?
	 * 6- sexto
	 * Sente-se útil na vida que está levando?
	 * 7- setimo
	 * Voce alguma vez pensou ou está pensando em se machucar agora?
	 * 8- oitavo
	 * Voce tem se sentido tão mal que chega a pensar em se machucar?
	 * 9- nono
	 * Voce tem um plano para se matar?
	 * 10- decimo
	 * Voce tem um plano de como faria isso?
	 * 11- decimoPrimeiro
	...
	public PsicoAltoRisco(String cpfCliente, String primeiro, String segundo, String terceiro, String quarto, String quinto, String sexto,
			String setimo, String oitavo, String nono, String decimo, String decimoPrimeiro, Date dtCadastroHPAR) {
